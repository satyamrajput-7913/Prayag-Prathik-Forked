    ...
    return (
        ...
        >
            ...
            <div className="px-6 py-5 border-b border-emerald-200 bg-gradient-to-r from-emerald-600 to-teal-500 shadow-sm">
                <h1 className="text-xl font-bold text-white tracking-wide">Prayagraj Explorer</h1>
                <p className="text-xs text-emerald-100 mt-1">Plan your journey smartly</p>
            </div>
                ...
                <div className="flex flex-col">
                    ...
                    <div
                        className={`transition-all duration-300 ease-in-out overflow-hidden
                            ${isDestinationsOpen ? "max-h-[400px] opacity-100" : "max-h-0 opacity-0"}`}
                    >
                        ...
                        <div className="flex-1 overflow-y-auto pr-1 space-y-3 mt-2 h-72">
                            {filteredDestinations.length > 0 ? (
                                ...
                                <p className="text-xs text-neutral-400 px-2">No matches found</p>
                            )}
                        </div>
                    </div>
                </div>
